...
def get_parser():
    ...
    parser.add_argument('--epochs', type=int, default=128, help='Total epoch')
    ...
    parser.add_argument('--logpath', type=str, default='./pretrain/', help='path to save logs')
    ...
    parser.add_argument('--max_crop_p', type=int, default=400000, help='training: max point of scene for crop')
    parser.add_argument('--min_crop_p', type=int, default=50000, help='training: max point of scene for crop')
    ...
    parser.add_argument('--cluster_epoch', type=int, default=-1, help='after cluster_epoch, cluster start')
